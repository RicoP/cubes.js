...
var Sphere = (function() {
 ...
 function Statemachine(sphere, cubelist, goalpos, dimension) {
  ...
  this.tap = function(time, dir) {
   ...
   switch(state) {
    ...
    break;
    default:
    console.error("ERROR (" + "src/sphere.js" + ":" + 192 + ")", "unknow state.", state );
    break;
   }
  };
  markCubesWhoSeeMeAsWatching(sphere.position, -1);
 ...
 return function(position, cubelist, goalpos, dimension) {
  do { if(typeof position === "undefined" || typeof (position . x) === "undefined") { __error("No property " + "x" + " in " + "position", "src/sphere.js", 202); } } while(false);
  do { if(typeof position === "undefined" || typeof (position . y) === "undefined") { __error("No property " + "y" + " in " + "position", "src/sphere.js", 203); } } while(false);
  do { if(typeof position === "undefined" || typeof (position . z) === "undefined") { __error("No property " + "z" + " in " + "position", "src/sphere.js", 204); } } while(false);
  do { if(!(this !== window)) { __error("assertion failed: " + "this !== window" + " = " + (this !== window), "src/sphere.js", 205); } } while(false);
...
function drawSky(program) {
 ...
 var uTextureOffset = glGetUniformLocation(program, "uTextureOffset");
 var modelviewprojection = tmpmatrix;
 do { if(!(uModelviewprojection)) { __error("assertion failed: " + "uModelviewprojection" + " = " + (uModelviewprojection), "src/main.js", 404); } } while(false);
 do { if(!(uTexture)) { __error("assertion failed: " + "uTexture" + " = " + (uTexture), "src/main.js", 405); } } while(false);
 do { if(!(aTextureuv !== -1)) { __error("assertion failed: " + "aTextureuv !== -1" + " = " + (aTextureuv !== -1), "src/main.js", 406); } } while(false);
 do { if(!(aVertex !== -1)) { __error("assertion failed: " + "aVertex !== -1" + " = " + (aVertex !== -1), "src/main.js", 407); } } while(false);
 glBindBuffer(GL_ARRAY_BUFFER, skyBuffer);
...
function drawPath(program, path) {
 ...
 var uModelviewprojection = glGetUniformLocation(program, "uModelviewprojection");
 var modelviewprojection = tmpmatrix;
 do { if(!(aVertex !== -1)) { __error("assertion failed: " + "aVertex !== -1" + " = " + (aVertex !== -1), "src/main.js", 440); } } while(false);
 do { if(!(uModelviewprojection !== -1)) { __error("assertion failed: " + "uModelviewprojection !== -1" + " = " + (uModelviewprojection !== -1), "src/main.js", 441); } } while(false);
...
function createTexture(img) {
 do { if(!(img)) { __error("assertion failed: " + "img" + " = " + (img), "src/main.js", 469); } } while(false);
...
function loadNextLevel() {
 ...
 console.log("DEBUG (" + "src/main.js" + ":" + 563 + ")", "SEED", seed );
 map = MapCreate(seed);
 cubelist = [];
 for(var x = 0; x !== 16; x++)
  for(var y = 0; y !== 16; y++)
...
GLT.loadmanager.loadFiles({
 ...
 "error" : function(file, err) {
  console.error("ERROR (" + "src/main.js" + ":" + 619 + ")", file, err );
 },
