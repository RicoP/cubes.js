...
function drawSky(program) {
 ...
 var uTextureOffset = glGetUniformLocation(program, "uTextureOffset");
 var modelviewprojection = tmpmatrix;
 do { if(!(uModelviewprojection)) { __error("assertion failed: " + "uModelviewprojection" + " = " + (uModelviewprojection), "src/main.js", 416); } } while(false);
 do { if(!(uTexture)) { __error("assertion failed: " + "uTexture" + " = " + (uTexture), "src/main.js", 417); } } while(false);
 do { if(!(aTextureuv !== -1)) { __error("assertion failed: " + "aTextureuv !== -1" + " = " + (aTextureuv !== -1), "src/main.js", 418); } } while(false);
...
function drawPath(program, path) {
 ...
 var uModelviewprojection = glGetUniformLocation(program, "uModelviewprojection");
 var modelviewprojection = tmpmatrix;
 do { if(!(aVertex !== -1)) { __error("assertion failed: " + "aVertex !== -1" + " = " + (aVertex !== -1), "src/main.js", 452); } } while(false);
 do { if(!(uModelviewprojection !== -1)) { __error("assertion failed: " + "uModelviewprojection !== -1" + " = " + (uModelviewprojection !== -1), "src/main.js", 453); } } while(false);
...
function createTexture(img) {
 do { if(!(img)) { __error("assertion failed: " + "img" + " = " + (img), "src/main.js", 481); } } while(false);
...
function loadNextLevel() {
 ...
 console.log("DEBUG (" + "src/main.js" + ":" + 575 + ")", "SEED", seed );
 map = MapCreate(seed);
 cubelist = [];
 for(var x = 0; x !== 16; x++)
  for(var y = 0; y !== 16; y++)
...
GLT.loadmanager.loadFiles({
 ...
 "error" : function(file, err) {
  console.error("ERROR (" + "src/main.js" + ":" + 612 + ")", file, err );
 },
...
console.log("DEBUG (" + "src/main.js" + ":" + 708 + ")", "DEBUG Build:", "Sep 12 2012", "21:58:41" );
}
catch(e) {
 var m = e.message || e;
